...
def image_preprocessing():
    ...
    print("[7] Split color channels (TIF; 2D or 3D, also time series)")
    print("[8] Merge color channels (TIF; 2D or 3D, also time series)")
